...
const Root$2 = styled__default.default(ui.Button)(_ref30 => {
  ...
  return styled.css(_c$1 || (_c$1 = __template$3(["\n    position: relative;\n    width: 100%;\n\n    /* Line styling */\n    &[data-first] ", "::before {\n      height: 50%;\n      top: unset;\n      bottom: 0;\n    }\n\n    &[data-last] ", "::before {\n      height: 50%;\n    }\n\n    ", "\n  "])), IconWrapper, IconWrapper, $selected && styled.css(_b$1 || (_b$1 = __template$3(["\n      ", "::before {\n        background: transparent;\n      }\n    "])), IconWrapper));
});
const IconBox = styled__default.default(ui.Box)(_d$1 || (_d$1 = __template$3(["\n  background: var(--card-bg-color);\n  border-radius: 50px;\n  position: relative;\n  z-index: 2;\n"])));
const EventLabel = styled__default.default(ui.Text)(_e || (_e = __template$3(["\n  text-transform: capitalize;\n"])));
const TimestampBox = styled__default.default(ui.Box)(_f || (_f = __template$3(["\n  min-width: 1rem;\n  margin-left: ", ";\n"])), _ref31 => {
  let {
    theme
  } = _ref31;
...
const deskTool = sanity.definePlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-a821e9a6.js');
    }).then(function (n) {
      return n.index;
    })),
...
//# sourceMappingURL=desk-0bd96315.js.map
