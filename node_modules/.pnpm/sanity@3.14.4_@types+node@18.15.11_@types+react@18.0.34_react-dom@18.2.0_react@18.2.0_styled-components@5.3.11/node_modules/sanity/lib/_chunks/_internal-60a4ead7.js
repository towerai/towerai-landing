...
async function getBuildAction() {
  const mod = await import('./buildAction-e9c88bbe.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-f240c2ef.js');
...
async function getDevAction() {
  const mod = await import('./devAction-17dd7a25.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-96dba0b0.js');
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-8f0c5254.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-40958a9a.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-3d36542e.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
...
//# sourceMappingURL=_internal-60a4ead7.js.map
