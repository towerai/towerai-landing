...
class PortableTextEditor extends React__default.default.Component {
  constructor(props) {
     ...
     */
    __publicField(this, "change$", new rxjs.Subject());
    /**
     * A lookup table for all the relevant schema types for this portable text type.
     */
    __publicField(this, "schemaTypes");
    /**
    ...
    __publicField(this, "setEditable", editable => {
      this.editable = {
        ...this.editable,
        ...editable
      };
...
// Static API methods
__publicField(PortableTextEditor, "activeAnnotations", editor => {
  return editor && editor.editable ? editor.editable.activeAnnotations() : [];
});
__publicField(PortableTextEditor, "addAnnotation", (editor, type, value) => {
  var _a;
...
__publicField(PortableTextEditor, "getSelection", editor => {
  return editor.editable ? editor.editable.getSelection() : null;
});
__publicField(PortableTextEditor, "getValue", editor => {
  var _a;
